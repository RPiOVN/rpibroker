...
define([
	...
	'underscore_1.3.3',
	'backbone_0.9.2',  
  'text!../../../js/market/templates/projects.html',
  'Chart.2.3.0'
    ...
    render: function () {
      try {
        ...
        debugger;
        var msg = 'Error in projectView.js/render() Error: '+err.message;
        console.error(msg);
        log.push(msg);
        sendLog();
    ...
    graphProject: function() {
      try {
        ...
        debugger;
        var msg = 'Error in projectView.js/graphProject() Error: '+err.message;
        console.error(msg);
        log.push(msg);
        sendLog();
    ...
    projectSelectionToIndex: function(dropDownSelection) {
      try {
        ...
        debugger;
        var msg = 'Error in projectView.js/projectSelectionToIndex() Error: '+err.message;
        console.error(msg);
        log.push(msg);
        sendLog();
    ...
    drawPieChart: function(projModel) {
      try {
        ...
        debugger;
        var msg = 'Error in projectView.js/drawPieChart() Error: '+err.message;
        console.error(msg);
        log.push(msg);
        sendLog();
    ...
    drawHorzBarChart: function(projModel, projTitle, typesOfWork) {
      try {
        ...
        debugger;
        var msg = 'Error in projectView.js/drawHorzBarChart() Error: '+err.message;
        console.error(msg);
        log.push(msg);
        sendLog();
    ...
    getProjectStats: function(workArray) {
      try {
        ...
        debugger;
        var msg = 'Error in projectView.js/getProjectStats() Error: '+err.message;
        console.error(msg);
        log.push(msg);
        sendLog();
    ...
    getProjectStats2: function(projModel) {
      try {
        ...
        debugger;
        var msg = 'Error in projectView.js/getProjectStats2() Error: '+err.message;
        console.error(msg);
        log.push(msg);
        sendLog();
    ...
    getUserName: function(userId) {
      ...
      try {
        ...
        debugger;
        var msg = 'Error in projectView.js/getUserName() Error: '+err.message;
        console.error(msg);
        log.push(msg);
        sendLog();
